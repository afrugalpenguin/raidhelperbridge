...
- Buff optimiser — green Optimise button runs simulated annealing algorithm with 3-player rotations to maximise total buff coverage across all groups (undoable with Ctrl+Z)
